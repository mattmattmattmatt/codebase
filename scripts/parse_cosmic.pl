...
my $cosmic_output = defined $OPT{cosmic_out}?$OPT{cosmic_out}:'GRCh37.cosmic';
...
while (<FILE>) {
	...
	my ($genename,$ens,undef,undef,undef,undef,undef,$prim,$sub,undef,undef,$hist,undef,undef,undef,undef,undef,$base_str,$aa_str,$mut_type,undef,undef,undef,$coord_str,$strand,$somatic_str,undef,undef,$tumour_type) = @fields;
