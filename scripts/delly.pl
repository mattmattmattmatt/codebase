...
delly.pl -bam bam_input -outvcf delly_out_vcf -outfile delly_out_file -runid runid -fast run_with_faster_params
...
my $file_name = $sample_name . '_' . $runid . '.delly.sv.xml';
